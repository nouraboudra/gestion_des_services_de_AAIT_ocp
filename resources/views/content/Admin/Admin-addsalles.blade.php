                    ...
                    <form id="Adduser" action="{{ route('salles.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="code" name="code" required placeholder="Code" autofocus>
                            </div>
                            <div class="col-md-8">
                                <label for="intitule" class="form-label">Intitule</label>
                                <input type="text" class="form-control" id="intitule" name="intitule" required placeholder="Intitule" autofocus>
                            </div>
                        </div>
                        <!-- ... Your other code ... -->
                        ...
                        <div class="mt-2 mb-3">
                            ...
                            <select id="Batiment" class="form-select" name="batiment" onchange="showHideFields()" required>
                        ...
                        <div id="otherBatimentField" style="display: none;">
                            <div class="mt-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="autreBatiment" name="autre_batiment" placeholder="Autre Bâtiment">
                            </div>
                        </div>
                        <div class="mt-2 mb-3">
                            <label for="smallSelect" class="form-label">Type_salle</label>
                            <select id="smallSelect" class="form-select" name="typesalle" onchange="showHideFields()" required>
                        ...
                        <div id="otherTypeSalleField" style="display: none;">
                            <div class="mt-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="autreTypeSalle" name="autre_type_salle" placeholder="Autre Type_salle">
                            </div>
                        </div>
