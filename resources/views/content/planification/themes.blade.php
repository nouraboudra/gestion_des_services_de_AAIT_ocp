...
<h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Planification /</span> Thèmes
</h4>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-lg">
            <h5 class="card-header">Les Thèmes</h5>
                    ...
                    <div>
                        <table class="table  ">
                            ...
                            <tbody class="table-border-bottom-0">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"><i class="bx bx-edit-alt me-1"></i> Modifier</a>
                                                <form action="{{ route('planing.themes.destroy', $theme->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                @empty 
                                <tr><td colspan="2"> Pas de Thèmes </td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
...
<div class="modal-content">
    ...
    <!-- Form -->
<form method="POST" action="{{ route('planing.themes.store') }}">
    @csrf
